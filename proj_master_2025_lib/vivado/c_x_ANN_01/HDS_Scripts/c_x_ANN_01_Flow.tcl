...
set ::errorCount 0
if {[catch {source ./HDS_Scripts/c_x_ANN_01_Create.tcl} errMsg]} {
...
if {$::errorCount == 0} {
   puts "Note: \"source ./HDS_Scripts/c_x_ANN_01_Create.tcl\" completed successfully\n"
} else {
   puts "Error: \"source ./HDS_Scripts/c_x_ANN_01_Create.tcl\" completed with errors\n"
}
