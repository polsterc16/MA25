...
architecture struct of tb_003_layer is
   ...
   signal layer_in0    : t_array_data_stdlv(0 to 3);
   signal layer_in1    : t_array_data_stdlv(0 to 3);
...
begin
   ...
   begin
    ...
    layer_in0(1) <= STD_LOGIC_VECTOR(TO_SIGNED(24, c_DATA_WIDTH));
    layer_in0(1) <= STD_LOGIC_VECTOR(TO_SIGNED(-60, c_DATA_WIDTH));
   ...
   U_0 : c_004_layer_01
      generic map (
         g_layer_length_cur  => 4,
         g_layer_length_prev => 4,
