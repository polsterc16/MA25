...
architecture struct of tb_003_layer is
   ...
   signal layer_out2   : t_array_data_stdlv(0 to 1);
...
begin
   ...
   begin
    ...
    layer_in0(0) <= STD_LOGIC_VECTOR(TO_SIGNED(0, c_DATA_WIDTH));
    layer_in0(1) <= STD_LOGIC_VECTOR(TO_SIGNED(-256, c_DATA_WIDTH));
   ...
   U_1 : c_004_layer_01
      generic map (
         ...
         g_layer_bias        => ( 567, 0),
         g_layer_weights     => ((-1943, -1910, -1662, -1882, -2053, -2020, -2076, -1988), (0,0,0,0,0,0,0,0)),
