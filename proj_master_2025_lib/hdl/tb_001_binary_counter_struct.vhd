...
architecture struct of tb_001_binary_counter is
   ...
   component c_001_binary_counter
   generic (
      nbits_g : integer := 8
   );
   port (
   ...
   for all : c_001_binary_counter use entity proj_master_2025_lib.c_001_binary_counter;
   -- pragma synthesis_on
